...
public class Static01 {
     ...
     static int sCounter = 0;//To create a static variable use "static" keyword before "return type"
     int iCounter = 0; //To create instance variable do not use "static" keyword
